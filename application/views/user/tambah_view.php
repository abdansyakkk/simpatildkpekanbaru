	...
	<div class="row">
	    <div class="col-md-12">
	        <div class="box box-primary">
			    ...
			    <!-- /.box-header -->
			    <div class="box-body">
                    <form action="<?php echo base_url('user/add');?>" method="POST" enctype="multipart/form-data"><?php echo '<input type="hidden" name="'.$this->security->get_csrf_token_name().'" value="'.$this->security->get_csrf_hash().'">'; ?>
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <label>NIP/NIK</label>
                                    <input type="text" class="form-control" name="nip" required="required" placeholder="NIP/NIK">
                                </div>
                                <div class="form-group">
